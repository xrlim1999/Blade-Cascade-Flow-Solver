...
def airfoil_performance_in_cascade_rotor(rho, alpha, beta, chord, t,
                                         ds, xmid, ymid, sine, cosine, slope,
                                         r1, r2, U, V, Omega,
                                         vorticity_U, vorticity_V, vorticity_Omega,
...
def airfoil_performance_in_cascade_stator(rho, alpha, beta, chord, t,
