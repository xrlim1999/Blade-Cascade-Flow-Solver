...
def solve_airfoil(
    *,
    ...
    flow_section    = FlowSection(operating_conditions["alpha0_deg"], operating_conditions["W0"], operating_conditions["rho"], operating_conditions["dynvisc"])

    # --- solver (initialisation) ---
    solver = AirfoilSolver(airfoil_section, flow_section)

    # --- solver ---
    solver.solve(plot_cp=plot_cp)
